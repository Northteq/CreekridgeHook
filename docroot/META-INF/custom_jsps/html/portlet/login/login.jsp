...
if(!hasPortalRole){
	...
	com.liferay.portal.kernel.struts.LastPath lastPath =(com.liferay.portal.kernel.struts.LastPath)session.getAttribute(com.liferay.portal.kernel.util.WebKeys.LAST_PATH);
	  

%>
<script type="text/javascript">
  window.location='<%=lastPath.getPath()%>';
</script>
<%} %>
	</c:when>
	<c:otherwise>
